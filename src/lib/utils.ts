...
export const STEP_NAMES: Record<number, string> = {
  ...
  // Phase 3 — บ.2 + บ.3
  10: "นิสิตอัปโหลด บ.2 + บ.3",
  11: "กรรมการสอบลงนาม บ.3",
  12: "อาจารย์ที่ปรึกษาลงนาม บ.2",
  13: "ประธานกรรมการสอบลงนาม บ.2",
  14: "ประธานหลักสูตรลงนาม บ.2",
  // Phase 4 — Admin relay
  15: "เจ้าหน้าที่นำส่งและรับเอกสารจากคณะ",
  // Phase 5 — Post-defense
  16: "นิสิตอัปโหลดเอกสารหลังสอบ",
  17: "ประธานกรรมการสอบลงนาม ใบรายงานผล",
  18: "อาจารย์ที่ปรึกษาลงนาม",
  19: "กรรมการสอบลงนาม ใบรายงานผล",
  20: "กรรมการภายนอกลงนาม ใบรายงานผล",
  21: "ประธานหลักสูตรลงนาม ใบรายงานผล",
  // Phase 6 — Thesis submission
  22: "นิสิตอัปโหลด บ.4 + วิทยานิพนธ์",
  23: "ประธานหลักสูตรลงนาม บ.4",
  24: "ประธานกรรมการสอบลงนามปกวิทยานิพนธ์",
  25: "อาจารย์ที่ปรึกษาลงนามปกวิทยานิพนธ์",
  26: "กรรมการสอบลงนามปกวิทยานิพนธ์",
  27: "กรรมการภายนอกลงนามปกวิทยานิพนธ์",
};
